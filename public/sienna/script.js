...
function generateAwardCard(awardTitle, organizationName, imageUrl) {
  const award_no_img = 'http://localhost:8000/sienna/assets/images/award_no_img.png';
  return `
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  if (data.profile) {
    ...
    user_bg.src = (profile.profileBanner==null)?'http://localhost:8000/sienna/assets/images/user_bg.png':profile.profileBanner.public;
    avatar.src = (profile.profilePicture==null)?'http://localhost:8000/sienna/assets/images/user.png':profile.profilePicture.public;
